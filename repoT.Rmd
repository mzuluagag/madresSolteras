...
<p style = "font-size:20px">
Además de estas variables, se creó la variable "Edad promedio de los hijos con los que vive".<br>A continuación veremos un pequeño análisis exploratorio de los datos:
</p>
```{r,echo=FALSE}
