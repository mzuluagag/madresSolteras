...
```
<p style = "font-size:20px" align="justify">
Con esta gráfica podemos observar que en su mayoría los datos tienen a los mayores números, es decir que las madres análizadas, en general consideran que lo que hacen con su vida vale la pena.
</p>
<hr>
...
<p style = "font-size:20px" align="justify">
Con esta gráfica, se puede observar que en su mayoría las madres análizadas no alzanzaron un alto nivel de educación, la mayoría no pasan de la educación media.
</p><hr>
```{r,echo=FALSE}
ggplot(count, aes(x = Var1, y = Freq)) +
...
8 & Tecnólogo sin título \\ 
9 & Tecnólogo con título \\ 
...
Aparentemente se puede ver que los datos se distribuyen normalmente, ya que los datos se están centrado alrededor de la media que es 5.34 aproximádamente con varianza 1.04, por lo tanto se puede entender y ver que la mayoría de datos están cerca a la media la mayoría, más o menos entre 4 y 7.
```{r,echo=FALSE}
