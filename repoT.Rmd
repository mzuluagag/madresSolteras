...
<p style = "font-size:20px" align="justify">
Aparentemente se puede visualizar que los datos siguen una distribución normal. Los datos están centrados alrededor de la media que es 5.34 aproximádamente, con varianza 1.04; por lo tanto se puede entender y ver que la mayoría de los datos están alrededor a la media entre los valores 4 y 7.
</p>
